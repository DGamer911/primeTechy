const Footer = () => {
  return (
    <footer className="bg-dark text-light pt-5 w-100">
        ...
        <div className="row g-4">
          ...
          <div className="col-md-2">
            ...
            <ul className="list-unstyled">
              <li><a href="#" className="text-secondary text-decoration-none">Laptops</a></li>
              <li><a href="#" className="text-secondary text-decoration-none">Smartphones</a></li>
              <li><a href="#" className="text-secondary text-decoration-none">Tablets</a></li>
